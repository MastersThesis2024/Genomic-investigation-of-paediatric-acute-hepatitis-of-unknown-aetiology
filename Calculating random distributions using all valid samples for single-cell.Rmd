...
gene_therapy <- read.csv("path/to/xxxxx.xxxxx159_geneTherapy_tpm_PC0.001_log2_genesymbol_dedup_subsetGenes.csv", header=T)
AAV2_outbreak <- read.csv("path/to/Log2_TPM_dedup_AAV2Liver_filtered_subsetGenes.csv", header=T)
seroneg_hep <- read.csv("path/to/seronegativeHep_tpm_PC0.001_log2_genesymbol_dedup_withoutxxxxx.xxxxx027_subsetGenes.csv", header=T)
```
