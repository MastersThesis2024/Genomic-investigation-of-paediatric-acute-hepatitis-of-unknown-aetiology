...
```{r}
GSE142530_healthyLiver <- read.csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Cytokine modules/FINAL - all samples RD/zscores_GSE142530_healthyLiver_allsamplesRD.csv")
...
```{r}
zscores_AAV2 <- read_csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Cytokine modules/FINAL - all samples RD/zscores_natureAAV2liver_allsamplesRD.csv")
...
```{r}
zscores_brain <- read_csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Cytokine modules/FINAL - all samples RD/zscores_X23LM.095V0104_brain_allsamplesRD.csv")

brain <- zscores_brain %>% 
  mutate("Class"="Brain") %>% #class name can change 
  rename("Module"=regulator, "Zscore"=X23LM.095V0104) %>% #CHANGE HERE!
...
```{r}
zscores_gene_therapy <- read_csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Cytokine modules/FINAL - all samples RD/zscores_22LM-318V0159_geneTherapy_allsamplesRD.csv")

gene_therapy <- zscores_gene_therapy %>% 
  mutate("Class"="Gene Therapy") %>% #class name can change 
  rename("Module"=regulator, "Zscore"=X22LM.318V0159) %>% #CHANGE HERE!
  select(-"...1") %>% # removes the ...1 column
...
```{r}
zscores_24LM060V0035 <- read_csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Cytokine modules/FINAL - all samples RD/zscores_Seronegative_Hepatitis_24LM.060V0035_allsamplesRD.csv")
...
```{r}
zscores_24LM071V0045 <- read_csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Cytokine modules/FINAL - all samples RD/zscores_Seronegative_Hepatitis_24LM.071V0045_allsamplesRD.csv")
...
f$Class <- factor(f$Class, levels = c("Normal", "AAV2", "Gene Therapy", "24LM-060V0035", "24LM-071V0045", "Brain")) 
```
