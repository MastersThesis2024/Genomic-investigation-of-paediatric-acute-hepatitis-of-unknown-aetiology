...
```{r}
GSE142530_healthyLiver <- read.csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Single-cell modules/FINAL - all samples RD/zscores_GSE142530_healthyLiver_singleCellModules_allsamplesRD.csv")
...
```{r}
zscores_AAV2 <- read_csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Single-cell modules/FINAL - all samples RD/zscores_AAV2Liver_singleCellModules_allsamplesRD.csv")
...
```{r}
zscores_brain <- read_csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Single-cell modules/FINAL - all samples RD/zscores_brain_singleCellModules_allsamplesRD.csv")

brain <- zscores_brain %>% 
  mutate("Class"="Brain") %>% #class name can change 
  rename("Module"=cell_type, "Zscore"=X23LM.095V0104) %>% #CHANGE HERE!
  select(-"...1") %>% # removes the ...1 column
  mutate("Sample"="X23LM.095V0104") #CHANGE HERE!
```

Load 22LM-318V0159 gene therapy sample Z-scores and reformat data
```{r}
zscores_gene_therapy <- read_csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Single-cell modules/FINAL - all samples RD/zscores_geneTherapy_singleCellModules_allsamplesRD.csv")

gene_therapy <- zscores_gene_therapy %>% 
  mutate("Class"="Gene Therapy") %>% #class name can change 
  rename("Module"=cell_type, "Zscore"=X22LM.318V0159) %>% #CHANGE HERE!
  select(-"...1") %>% # removes the ...1 column
  mutate("Sample"="X22LM.318V0159") #CHANGE HERE!
```

Load 24LM-060V0035 Z-scores and reformat data 
```{r}
zscores_24LM060V0035 <- read_csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Single-cell modules/FINAL - all samples RD/zscores_Seronegative_Hepatitis_24LM.060V0035_singleCellModules_allsamplesRD.csv")
dim(zscores_24LM060V0035)

zscores_24LM060V0035_long <- zscores_24LM060V0035 %>% 
  pivot_longer(3, names_to = "Sample", values_to = "Zscore") %>% 
  mutate("Class"="24LM-060V0035") %>%
  rename("Module"="cell_type") %>% 
   select(-"...1")
```

Load 24LM-060V0045 Z-scores and reformat data 
```{r}
zscores_24LM071V0045 <- read_csv("C:/Users/iring/OneDrive/Documents/UCL/Msc Cell and Gene Therapy Research Project/Transcriptomics/Final Transcriptomics Calculations/Single-cell modules/FINAL - all samples RD/zscores_Seronegative_Hepatitis_24LM.071V0045_singleCellModules_allsamplesRD.csv")
dim(zscores_24LM071V0045)

zscores_24LM071V0045_long <- zscores_24LM071V0045 %>% 
  pivot_longer(3, names_to = "Sample", values_to = "Zscore") %>% 
  mutate("Class"="24LM-071V0045") %>%
  rename("Module"="cell_type") %>% 
   select(-"...1")
```
...
```{r}
e <- rbind(GSE142530_healthyLiver_long, zscores_AAV2_long, brain, gene_therapy, zscores_24LM060V0035_long, zscores_24LM071V0045_long)
f <- e %>% 
...
ontogeny$Class <- factor(ontogeny$Class, levels = c("Normal", "AAV2", "Gene Therapy", "24LM-060V0035", "24LM-071V0045", "Brain"))
Tcell_subsets$Class <- factor(Tcell_subsets$Class, levels = c("Normal", "AAV2", "Gene Therapy", "24LM-060V0035", "24LM-071V0045", "Brain"))
Tcell_functions$Class <- factor(Tcell_functions$Class, levels = c("Normal", "AAV2", "Gene Therapy", "24LM-060V0035", "24LM-071V0045", "Brain"))
myeloid_functions$Class <- factor(myeloid_functions$Class, levels = c("Normal", "AAV2", "Gene Therapy", "24LM-060V0035", "24LM-071V0045", "Brain"))
```
...
pca_calc1 %>% augment(mydata_forpca1) %>%  ggplot(aes(.fittedPC1, .fittedPC2, color = Class))+ 
  geom_point(size = 2)+
  scale_color_manual(values=c(Normal="#92a0b3",AAV2="#de102a", "Gene Therapy"="#ff7821", "24LM-060V0035"="#F781BF", "24LM-071V0045"="#b87dc1", Brain= "#4DAF4A"))+
  labs(x="PC1",y="PC2")+
  My_Theme
```
...
ann$Class <- factor(ann$Class, levels = c("Normal","AAV2", "Gene Therapy", "24LM-060V0035", "24LM-071V0045", "Brain"))
colours <- list("Class" = c(
  "Normal"=	"#92a0b3",
  "AAV2"=	"#de102a",
  "Gene Therapy"=	"#ff7821",
  "24LM-060V0035"="#F781BF",
  "24LM-071V0045"="#b87dc1",
  "Brain" = "#4DAF4A"))
